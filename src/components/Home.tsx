          ...
          <div className="button-wrapper">
            <Link to="/booking/single">
              <div className="button single-booking">
                <span role="img" aria-label="Single Person Booking">👤</span> Single Person Booking
              </div>
            </Link>
          ...
          <div className="button-wrapper">
            <Link to="/booking/multiple">
              <div className="button multiple-booking">
                <span role="img" aria-label="Multiple Person Booking">👥</span> Multiple Person Booking
              </div>
            </Link>
